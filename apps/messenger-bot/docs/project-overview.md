...
- **LLM failover:** `LLM_PROVIDER_FAILOVER_ORDER` (CSV: `openai,openrouter,minimax`; rỗng = không failover), `OPENROUTER_API_KEY`, `OPENROUTER_MODEL`, `OPENROUTER_BASE_URL`, `MINIMAX_API_KEY`, `MINIMAX_MODEL`, `MINIMAX_BASE_URL`
