...
| **C2** | Event store / billing LLM | 2+ ngày | Product — [c2-master-implementation-plan.md](./c2-master-implementation-plan.md) |
...
| Event store / billing | Khó audit chi phí LLM theo tháng | [c2-master-implementation-plan.md](./c2-master-implementation-plan.md) | **C2** |
